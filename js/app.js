    ...
    showInspectionItems: function () {
        ...
        sheets.forEach(function (sheetName) {
            ...
            card.innerHTML =
                ...
                '<div><p class="!text-xs text-slate-400 uppercase font-bold">' + self.t('目標值', 'Target') + '</p><p class="!text-base font-mono font-bold text-slate-600 dark:text-slate-300">' + target + '</p></div>' +
                '<div><p class="!text-xs text-slate-400 uppercase font-bold">' + self.t('樣本數', 'Samples') + '</p><p class="!text-base font-mono font-bold text-slate-600 dark:text-slate-300">' + sampleCount + '</p></div>' +
                '</div>' +
                '</div>' +
                '</div>';
