...
var SPCApp = {
    ...
    renderCharts: function () {
        ...
        if (data.type === 'batch') {
            ...
            var xOpt = {
                chart: { type: 'line', height: 380, toolbar: { show: false }, background: 'transparent', events: { dblclick: function (e, c) { c.resetSeries(); } } },
            ...
            var rOpt = {
                chart: { type: 'line', height: 300, toolbar: { show: false }, background: 'transparent', events: { dblclick: function (e, c) { c.resetSeries(); } } },
                theme: { mode: theme.mode },
                series: [
            ...
            var cpkOpt = {
                chart: { type: 'bar', height: 350, toolbar: { show: false }, background: 'transparent', events: { dblclick: function (e, c) { c.resetSeries(); } } },
                theme: { mode: theme.mode },
            ...
            var meanOpt = {
                chart: { type: 'line', height: 350, toolbar: { show: false }, background: 'transparent', events: { dblclick: function (e, c) { c.resetSeries(); } } },
                theme: { mode: theme.mode },
                series: [
            ...
            var gOpt = {
                chart: { type: 'line', height: 380, toolbar: { show: false }, events: { dblclick: function (e, c) { c.resetSeries(); } } },
                theme: { mode: theme.mode },
                series: [
