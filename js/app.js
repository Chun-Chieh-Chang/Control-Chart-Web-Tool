    ...
    showInspectionItems: function () {
        ...
        sheets.forEach(function (sheetName) {
            ...
            card.innerHTML =
                ...
                '</div>' +
                '<div>' +
                '<h3 class="text-base font-bold text-slate-900 dark:text-white truncate mb-4">' + sheetName + '</h3>' +
                '<div class="grid grid-cols-2 gap-2">' +
                '<div><p class="text-[11px] text-slate-400 uppercase font-bold">' + self.t('目標值', 'Target') + '</p><p class="text-sm font-mono font-bold text-slate-600 dark:text-slate-300">' + target + '</p></div>' +
                '<div><p class="text-[11px] text-slate-400 uppercase font-bold">' + self.t('樣本數', 'Samples') + '</p><p class="text-sm font-mono font-bold text-slate-600 dark:text-slate-300">' + sampleCount + '</p></div>' +
                '</div>' +
                '</div>' +
                '</div>';
