            ...
            var dOpt = {
                ...
                annotations: {
                    ...
                    points: [
                        ...
                        { x: data.markers.s2p.x, y: data.markers.s2p.y, marker: { size: 4, fillColor: '#f59e0b' }, label: { text: '+2σ (' + data.markers.s2p.x.toFixed(4) + ')', style: { background: 'rgba(245, 158, 11, 0.1)', color: '#d97706', fontSize: '10px' }, offsetY: -10 } },
                        { x: data.markers.s2n.x, y: data.markers.s2n.y, marker: { size: 4, fillColor: '#f59e0b' }, label: { text: '-2σ (' + data.markers.s2n.x.toFixed(4) + ')', style: { background: 'rgba(245, 158, 11, 0.1)', color: '#d97706', fontSize: '10px' }, offsetY: -10 } },
